...
class WriteTrainJSON:
    ...
    python3 step0a_create_train_json.py --dataroot /var/data/MONAI_Choroid_Plexus/dataset_monai_train_from_scratch --description "Dataset for Choroid Plexus segmentation" --work_dir /var/data/student_home/user/project_dir/monai_segmentation/monai_training --train_json train.json
    ...
    def __init__(self, dataroot: str=".", description=None, work_dir: str=".", train_json: str="train.json"):
        ...
        :param work_dir: The working directory. (/var/data/student_home/user/project_dir/monai_segmentation/monai_training)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work_dir', required=True, default="/var/data/student_home/user/project_dir/monai_segmentation/monai_training", help="working directory")
