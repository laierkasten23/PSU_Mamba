...
if __name__ == "__main__":
    ...
    if args.save_results:
        ...
        '''
        Example:
        python statistical_pretests_t1mdc_vs_t1xflair_vs_t1.py --subjects_dir /data1/user/T1mc_vs_T1xFLAIR_controlled_OK --file_ending1 _ChP_mask_T1.nii --file_ending2 _ChP_mask_FLAIR.nii --output_dir ~/projects/project_dir/PRL/ --output_file PRL_preanalysis_T1mdc_vs_FLAIR.csv --save_results
