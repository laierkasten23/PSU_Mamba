...
def folderstructure_changer_symbolic(path, 
    ...
    #--------------- Start creating the symbolic links -------------------
...
def folderstructure_changer_symbolic2(path, 
                            amount_train_subjects:int =5, 
                            train_val_split:float = 0.8,
                            train_test_index_list: Union[List, None] = None):
    """
    This function just splits the data into train and test data.
        -MRI_IDsj
    ...
    to the following structure:
        ...
        If train_val_index_list is given, the data is split into train and test data according to the given list.
        Otherwise, the data is split randomly according to the given amount of train subjects.
    """
