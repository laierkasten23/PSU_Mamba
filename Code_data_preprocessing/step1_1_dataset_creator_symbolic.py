...
def folderstructure_changer_symbolic(path, 
    ...
    # randomly subsample also validation subjects or use the given list of folds for train and validation # : include and generate the lists
    elif datasettype == 'UMAMBA':
        ...
        if umamba_fold_json_path is not None:
            ...
            for idx, (train_subjects_fold, val_subjects_fold) in enumerate(zip(train_subject_all_folds, val_subject_all_folds)):
                ...
                for subject in train_subjects_fold: # : continue here!!!!!
        ...
        for subject in subjects:
            ...
            if not test_data_only:
                ...
                image_name = next((s for s in subject_dir_list if modality in s and 'mask' not in s), None)
                # : include use_single_label_for_bichannel also for test_data_only 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='/home/linuxuser/user/data/pazienti', help='Path to the dataset')
