...
from nnunetv2.nets.UMambaFirst_patch16 import get_umamba_first_3d_from_plans
...
class nnUNetTrainerMambaFirstStem_PCA_patch16_32(nnUNetTrainer):
    """
    ...
    def on_train_epoch_end(self, train_outputs: List[dict]):
        ...
        patch_size = (16, 16, 16)
        stride = (16, 16, 16)  # non-overlapping; change for overlap if desired
