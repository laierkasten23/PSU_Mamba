...
class WriteJSON:
    ...
    # initialization
    def __init__(self, dataroot: str=".", benchmark_dataroot: str=".", description=None, work_dir: str=".", finetune: str=".", prediction: str="."):
   
        self.Dataroot=dataroot
        self.Benchmark_dataroot=benchmark_dataroot
    ...
    def write_json_file(self):
        ...
        if (train_id and test_id) or (not(train_id) and test_id) or (train_id and not(test_id)):
            ...
            json_dict['data_benchmark_base_dir'] = self.Benchmark_dataroot
