...
--path "$path" \
--task_id "$task_id" \
--task_name 'ChoroidPlexus_T1_sym_AP' \
...
#--path "$path" \
#--task_id "$task_id" \
#--task_name 'ChoroidPlexus_FLAIR_sym_AP' \
#--datasettype "$datasettype" \
#--train_test_index_list "$train_test_index_list" \
#--modality "FLAIR"
...
#--path "$path" \
#--task_id "$task_id" \
#--task_name 'ChoroidPlexus_T1xFLAIR_sym_AP' \
#--datasettype "$datasettype" \
#--train_test_index_list "$train_test_index_list" \
#--modality "T1xFLAIR"
...
#--path "$path" \
#--task_id "$task_id" \
#--task_name 'ChoroidPlexus_T1_FLAIR_sym_AP' \
#--datasettype "$datasettype" \
#--train_test_index_list "$train_test_index_list" \
#--modality 'T1' 'FLAIR'
...
#--path "$path" \
#--task_id "$task_id" \
#--task_name 'ChoroidPlexus_T1_FLAIR_T1xFLAIRmask_sym_AP' \
#--datasettype "$datasettype" \
#--train_test_index_list "$train_test_index_list" \
#--modality 'T1' 'FLAIR' \
