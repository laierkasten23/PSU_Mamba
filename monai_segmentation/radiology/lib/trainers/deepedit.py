...
class DeepEdit(BasicTrainTask):
    """
    DeepEdit is a class that represents a training task for the DeepEdit model for 3D Images.

    Args:
        model_dir (str): The directory to save the trained model.
        network: The network architecture for the model.
        description (str): A description of the training task. Default is "Train DeepEdit model for 3D Images".
        spatial_size (tuple): The spatial size of the input images. Default is (128, 128, 64).
        target_spacing (tuple): The target spacing of the input images. Default is (1.0, 1.0, 1.0).
        number_intensity_ch (int): The number of intensity channels. Default is 1.
        deepgrow_probability_train (float): The probability of using deepgrow during training. Default is 0.4.
        deepgrow_probability_val (float): The probability of using deepgrow during validation. Default is 1.0.
        debug_mode (bool): Whether to enable debug mode. Default is False.
        **kwargs: Additional keyword arguments.

    Attributes:
        _network: The network architecture for the model.
        spatial_size (tuple): The spatial size of the input images.
        target_spacing (tuple): The target spacing of the input images.
        number_intensity_ch (int): The number of intensity channels.
        deepgrow_probability_train (float): The probability of using deepgrow during training.
        deepgrow_probability_val (float): The probability of using deepgrow during validation.
        debug_mode (bool): Whether debug mode is enabled.

    Methods:
        network: Returns the network architecture.
        optimizer: Returns the optimizer.
        loss_function: Returns the loss function.
        get_click_transforms: Returns the click transforms.
        train_pre_transforms: Returns the pre-transforms for training.
        train_post_transforms: Returns the post-transforms for training.
        val_pre_transforms: Returns the pre-transforms for validation.
        val_inferer: Returns the inferer for validation.
        train_iteration_update: Returns the iteration update for training.
        val_iteration_update: Returns the iteration update for validation.
        train_key_metric: Returns the key metrics for training.
        val_key_metric: Returns the key metrics for validation.
        train_handlers: Returns the handlers for training.
    """
    def __init__(
        self,
        model_dir,
